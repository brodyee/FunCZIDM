...
FunCZIDMSampler <- function(ITER, COUNTS, X, ID_END_IDX, RAND_EFF_COLS, BURN_IN = 0L, NUM_THIN = 1L, ADJ_FREQ = 250L, PROPOSAL_CAP = 0.0, ZI_GROUPED = TRUE, ADJ_PROPOSALS = TRUE, RETURN_BURN_IN = FALSE, CAP_PROPOSALS = FALSE, PRINT_PROGRESS = TRUE, TO_RETRUN = characterVector(), betaInitial = NULL, rInitial = NULL, priors = NULL, proposalVars = NULL) {
...
getFitOfData2 <- function(beta, basis, covariates, covIdxs) {
    .Call(`_FunCZIDM_getFitOfData2`, beta, basis, covariates, covIdxs)
}
