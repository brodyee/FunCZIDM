...
//[[Rcpp::export]]
List VarCoDMSampler(const int ITER, const arma::umat COUNTS, const arma::mat X, 
  ...
  gamma = arma::exp(X*beta); sampleCnoZI(c, COUNTS, u, gamma);
